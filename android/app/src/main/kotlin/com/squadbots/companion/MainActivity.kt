 ...
 *
 * Connect/disconnect is not here: `SquadbotsApp` drives it from
 * `ProcessLifecycleOwner`, which is the Android shape of iOS's `scenePhase`.
 */
class MainActivity : ComponentActivity() {
    private val app: SquadbotsApp
        get() = application as SquadbotsApp
    ...
    private companion object {
        const val STATE_CONSUMED_NOTIFICATION = "squadbots.consumedNotification"
