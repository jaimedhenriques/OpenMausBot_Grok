...
person can choose **Squadbots**, review the paired computer and destination,
...
ios/
  ...
  App/                           SwiftUI, and everything that needs a device
    ...
    Discovery.swift              NWBrowser for _squadbots._tcp
...
through manual MagicDNS entry; it is not a dependency and Squadbots does not
