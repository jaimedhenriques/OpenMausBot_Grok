...
person can choose **Softbots**, review the paired computer and destination,
...
ios/
  ...
  App/                           SwiftUI, and everything that needs a device
    ...
    Discovery.swift              NWBrowser for _softbots._tcp
...
through manual MagicDNS entry; it is not a dependency and Softbots does not
