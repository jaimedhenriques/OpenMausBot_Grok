...
- Privacy policy URL:
  `https://github.com/jaimedhenriques/OpenMausBot_Grok/blob/main/docs/ios-privacy.md`
...
companion computer, and local Wi-Fi and Tailscale pairing require no Squadbots
...
**Send**. They are written to that computer's local Squadbots attachments
