...
- Privacy policy URL:
  `https://github.com/milind-soni/Softbots/blob/main/docs/ios-privacy.md`
...
companion computer, and local Wi-Fi and Tailscale pairing require no Softbots
...
**Send**. They are written to that computer's local Softbots attachments
