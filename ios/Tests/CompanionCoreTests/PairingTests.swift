...
final class PairingTests: XCTestCase {
    ...
    func testRejectsAServiceThatDoesNotIdentifyAsSquadbots() async throws {
    ...
    private static let health = Data(#"{"app":"squadbots","pid":42,"static":true}"#.utf8)
