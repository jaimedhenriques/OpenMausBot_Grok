...
final class ServerPairingTests: XCTestCase {
    ...
    func testTheServersLinkBecomesAHostedInviteWithTheNormalizedCode() throws {
        let invite = try XCTUnwrap(PairingInvite.parse(XCTUnwrap(URL(string: "https://c-7f3a9c.softbots.com/pair#code=abcd-efgh-jklm"))))
        XCTAssertEqual(invite.credential, "ABCDEFGHJKLM")
        XCTAssertEqual(invite.connection.activeEndpoint?.kind, .hosted)
        XCTAssertEqual(invite.connection.activeEndpoint?.url, "https://c-7f3a9c.softbots.com")
        XCTAssertEqual(invite.connection.host, "c-7f3a9c.softbots.com")
    ...
    func testPairingPostsTheCodeWithoutACookieAndKeepsTheBearer() async throws {
        ...
        XCTAssertEqual(request.url?.absoluteString, "https://c-7f3a9c.softbots.com/api/auth/pair")
    ...
    func testOnlyAnAdminScopedServerSessionMayAdminister() throws {
        ...
        var chatOnly = try XCTUnwrap(Connection.parse("https://c-7f3a9c.softbots.com"))
        ...
        let earlier = Data(#"{"id":"s1","name":"cab mini","host":"c-7f3a9c.softbots.com","port":443,"serverEnvironmentId":"env_7f3a9c"}"#.utf8)
    ...
    func testAServerConnectionsStreamCarriesTheBearerAndResumesFromTheCursor() async throws {
        ...
        var connection = try XCTUnwrap(Connection.parse("https://c-7f3a9c.softbots.com"))
        ...
        XCTAssertEqual(components.host, "c-7f3a9c.softbots.com")
