...
export const GROUP_GOAL_CONTROL_OPEN = "<squadbots-goal>";
export const GROUP_GOAL_CONTROL_CLOSE = "</squadbots-goal>";
...
export function groupGoalWorkerInstructions(args: {
  ...
  return [
    ...
    `Address your result to ${args.coordinatorName}. Do not invent a new orchestration protocol or emit an squadbots-goal control envelope.`,
  ].join("\n");
}
