...
export const GROUP_GOAL_CONTROL_OPEN = "<softbots-goal>";
export const GROUP_GOAL_CONTROL_CLOSE = "</softbots-goal>";
...
export function groupGoalWorkerInstructions(args: {
  ...
  return [
    ...
    `Address your result to ${args.coordinatorName}. Do not invent a new orchestration protocol or emit an softbots-goal control envelope.`,
  ].join("\n");
}
