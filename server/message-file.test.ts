...
describe("message-linked files", () => {
  ...
  it("keeps a Windows path's backslash before punctuation, as in \\.softbots", () => {
    const report = "C:\\Users\\Maus\\.softbots\\workspaces\\bot\\_drafts\\report.md";
    const chart = "C:\\Users\\Maus\\.softbots\\workspaces\\bot\\chart.png";
    const notes = "C:\\Users\\Maus\\.softbots\\release notes.md";
    ...
    expect(messageReferencesFile(markdown, "C:\\Users\\Maus.softbots\\workspaces\\bot_drafts\\report.md")).toBe(false);
  });
