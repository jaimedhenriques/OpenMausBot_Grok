...
async function probeRemoteMcpServer(
  ...
  try {
    await client.initialize("Softbots", combined);
 ...
 * tools. It is always reaped, never inherits Softbots credentials, and never
  ...
  return new Promise((resolve) => {
    ...
    write({
      ...
      params: {
        ...
        capabilities: {},
        clientInfo: { name: "Softbots", version: "probe" },
      },
    });
  });
}
