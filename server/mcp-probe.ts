...
async function probeRemoteMcpServer(
  ...
  try {
    await client.initialize("Squadbots", combined);
 ...
 * tools. It is always reaped, never inherits Squadbots credentials, and never
  ...
  return new Promise((resolve) => {
    ...
    write({
      ...
      params: {
        ...
        capabilities: {},
        clientInfo: { name: "Squadbots", version: "probe" },
      },
    });
  });
}
