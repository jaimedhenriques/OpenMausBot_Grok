...
export const BOT_PACKAGE_FORMAT = "squadbots.package" as const;
...
const packageSchema = z.object({
  format: z.literal(BOT_PACKAGE_FORMAT, { error: "This is not an Squadbots package" }),
 ...
 * run without Squadbots or another proprietary parser. */
