...
export const BOT_PACKAGE_FORMAT = "softbots.package" as const;
...
const packageSchema = z.object({
  format: z.literal(BOT_PACKAGE_FORMAT, { error: "This is not an Softbots package" }),
 ...
 * run without Softbots or another proprietary parser. */
