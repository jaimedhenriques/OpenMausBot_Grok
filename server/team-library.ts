...
export const TEAM_LIBRARY_REPOSITORY = "https://github.com/milind-soni/softbots-teams";
export const TEAM_LIBRARY_RAW_ROOT = "https://raw.githubusercontent.com/milind-soni/softbots-teams/main";
...
export function parseTeamCatalog(value: unknown): TeamCatalog {
  if (!isRecord(value) || value.format !== "squadbots.catalog" || value.version !== 1) {
