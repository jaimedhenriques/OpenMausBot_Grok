...
describe("message gallery", () => {
  ...
  it("sends a Windows path with its backslash before punctuation intact", () => {
    expect(collectMessageFiles("[report](C:\\Users\\Maus\\.softbots\\workspaces\\bot\\report.md)")).toEqual([
      { path: "C:\\Users\\Maus\\.softbots\\workspaces\\bot\\report.md", name: "report.md", linked: true },
    ]);
  });
