export const SOFT_GTM_CREAM = "#EFECE4";
...
export const SOFT_GTM_PRICING = "14-day Solo trial on the hosted app, then $29/mo BYO. Card required to start.";
export const SOFT_GTM_REVENUE = "Revenue unknown. £0 reported for this Soft GTM draft.";
export const SOFT_GTM_502 =
...
export const SOFT_GTM_HOLD = "Soft GTM draft. No customer send. Apache-2.0 license unchanged.";
