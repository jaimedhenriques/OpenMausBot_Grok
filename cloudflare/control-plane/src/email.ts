...
const SUBJECTS = {
  "sign-in": "Your Softbots sign-in code",
  "email-verification": "Verify your Softbots email",
  "forget-password": "Reset your Softbots password",
  "change-email": "Confirm your Softbots email change",
