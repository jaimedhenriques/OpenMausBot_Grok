...
const SUBJECTS = {
  "sign-in": "Your Squadbots sign-in code",
  "email-verification": "Verify your Squadbots email",
  "forget-password": "Reset your Squadbots password",
  "change-email": "Confirm your Squadbots email change",
...
export function buildOTPEmail(from: string, input: OTPEmailInput) {
  ...
  return {
    to: input.email,
    from: { email: from, name: "Squadbots" },
    subject,
    html,
    text,
  };
