...
/** Pairing tokens may travel through a verified Softbots HTTPS endpoint or
...
export async function pairDesktopCompanion({
  ...
  if (!endpoint) {
    throw new Error("Enter the Softbots HTTPS companion address or full Tailscale name ending in .ts.net");
  }
