...
const ENDPOINT = "https://c-opaque.softbots.com";
...
describe("Companion account service", () => {
  it("uses the packaged hosted default and only explicit safe development origins", () => {
    ...
    expect(resolveCompanionControlPlaneURL({
      isPackaged: true,
      environment: { OMB_CONTROL_PLANE_URL: "http://accounts.softbots.com" },
    })).toBe("");
    expect(resolveCompanionControlPlaneURL({
      isPackaged: true,
      environment: { OMB_CONTROL_PLANE_URL: new String("https://accounts.softbots.com") },
    })).toBe("");
