...
supply-chain contract tracked in [#113](https://github.com/jaimedhenriques/OpenMausBot_Grok/issues/113): pinned archive
...
receives the validated MCP proxy contract. Xorg is tracked in [#79](https://github.com/jaimedhenriques/OpenMausBot_Grok/issues/79);
GNOME/Wayland additionally requires WinRects v8 plus the exact Cua health-report contract tracked in
[#109](https://github.com/jaimedhenriques/OpenMausBot_Grok/issues/109).
