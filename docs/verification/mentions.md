...
Printed log:
`%TEMP%/squadbots-verification-evidence/server-1788957885515-22688.log`.
...
`%TEMP%/squadbots-verification-evidence/server-1788790736762-24868.log`.
...
`%TEMP%/squadbots-verification-evidence/server-1788791336713-2520.log`.
