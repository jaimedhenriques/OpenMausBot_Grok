...
The bot turns calendar timing into a cron expression, and Softbots validates
...
- Softbots must be running to dispatch routines, including cloud-targeted
  ...
  Softbots on a VPS — see [deploy-vps.md](deploy-vps.md).
