...
The bot turns calendar timing into a cron expression, and Squadbots validates
...
- Squadbots must be running to dispatch routines, including cloud-targeted
  ...
  Squadbots on a VPS — see [deploy-vps.md](deploy-vps.md).
