...
progress in [issue #29](https://github.com/jaimedhenriques/OpenMausBot_Grok/issues/29) and the safety hold in
[issue #345](https://github.com/jaimedhenriques/OpenMausBot_Grok/issues/345). Bundled
CUA supply-chain work is tracked in [issue #113](https://github.com/jaimedhenriques/OpenMausBot_Grok/issues/113). Xorg is tracked in
[issue #79](https://github.com/jaimedhenriques/OpenMausBot_Grok/issues/79), and guarded GNOME/Wayland support in
[issue #109](https://github.com/jaimedhenriques/OpenMausBot_Grok/issues/109).

## Download packages

Choose one Ubuntu 24.04 x86_64 package from the latest release:

- [Debian package (`Squadbots-amd64.deb`)](https://github.com/jaimedhenriques/OpenMausBot_Grok/releases/latest/download/Squadbots-amd64.deb) — recommended; APT installs its desktop dependencies and configures the bundled bot browser's sandbox.
- [Portable AppImage (`Squadbots.AppImage`)](https://github.com/jaimedhenriques/OpenMausBot_Grok/releases/latest/download/Squadbots.AppImage) — does not install system files.
- [SHA-256 checksums](https://github.com/jaimedhenriques/OpenMausBot_Grok/releases/latest/download/SHA256SUMS-ubuntu-x64.txt)

Versioned packages and previous releases remain available on the
[releases page](https://github.com/jaimedhenriques/OpenMausBot_Grok/releases).
...
```sh
git clone https://github.com/jaimedhenriques/OpenMausBot_Grok.git Squadbots
cd Squadbots
corepack enable
