...
progress in [issue #29](https://github.com/milind-soni/Softbots/issues/29) and the safety hold in
[issue #345](https://github.com/milind-soni/Softbots/issues/345). Bundled
CUA supply-chain work is tracked in [issue #113](https://github.com/milind-soni/Softbots/issues/113). Xorg is tracked in
[issue #79](https://github.com/milind-soni/Softbots/issues/79), and guarded GNOME/Wayland support in
[issue #109](https://github.com/milind-soni/Softbots/issues/109).

## Download packages

Choose one Ubuntu 24.04 x86_64 package from the latest release:

- [Debian package (`Softbots-amd64.deb`)](https://github.com/milind-soni/Softbots/releases/latest/download/Softbots-amd64.deb) — recommended; APT installs its desktop dependencies and configures the bundled bot browser's sandbox.
- [Portable AppImage (`Softbots.AppImage`)](https://github.com/milind-soni/Softbots/releases/latest/download/Softbots.AppImage) — does not install system files.
- [SHA-256 checksums](https://github.com/milind-soni/Softbots/releases/latest/download/SHA256SUMS-ubuntu-x64.txt)

Versioned packages and previous releases remain available on the
[releases page](https://github.com/milind-soni/Softbots/releases).
...
```sh
git clone https://github.com/milind-soni/Softbots.git
cd Softbots
corepack enable
