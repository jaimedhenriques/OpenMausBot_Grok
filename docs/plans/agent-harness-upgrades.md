# Softbots harness implementation plan
...
(pi, agent-orchestrator, deepseek-harness) and asking what Softbots lacked by
...
**The reframe that reorders everything.** Softbots is itself a harness. The
