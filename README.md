...
[![Release](https://img.shields.io/github/v/release/jaimedhenriques/OpenMausBot_Grok?label=release&color=1084fe&cacheSeconds=300)](https://github.com/jaimedhenriques/OpenMausBot_Grok/releases/latest)
...
- **Local first.** One small harness server on `127.0.0.1` owns every agent process. Transcripts, keys, and
  events live in `~/.softbots`, not a cloud.
...
[open-source playbook repository](https://github.com/milind-soni/softbots-teams) or read its
[portable format](https://github.com/milind-soni/softbots-teams/blob/main/FORMAT.md).
...
**Released builds ([latest release](https://github.com/jaimedhenriques/OpenMausBot_Grok/releases/latest)):** the harness server is embedded, so no separate server setup is required.
...
issues [#29](https://github.com/jaimedhenriques/OpenMausBot_Grok/issues/29),
[#345](https://github.com/jaimedhenriques/OpenMausBot_Grok/issues/345), and
[#113](https://github.com/jaimedhenriques/OpenMausBot_Grok/issues/113).
