...
function requireUpdaterTarget(resources, label) {
  ...
  if (!/^owner: jaimedhenriques$/m.test(update) || !/^repo: OpenMausBot_Grok$/m.test(update)) {
    fail(`${label} app-update.yml does not point at jaimedhenriques/OpenMausBot_Grok`);
  }
}
